...
#######################################################
# VPC Endpoints ECS, CloudWatch Logs, Systems Manager #
#######################################################

/* SG that provides access to vpc endpoint */
resource "aws_security_group" "vpc_endpoint_access" {
  ...
  // Rules
  ingress { // Gives access to all addresses into vpc
...
/*  Necessary endpoints so that ECR being posible */
...
resource "aws_vpc_endpoint" "ecr" {
  ...
  security_group_ids = [aws_security_group.vpc_endpoint_access.id]
